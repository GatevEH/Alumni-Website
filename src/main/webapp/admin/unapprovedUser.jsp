...
<style>
		...
		.addButton:link, .addButton:visited {
		...
		.deleteButton:visited, .deleteButton:link {
...
<div class="pageContent container-fluid" style="text-align:center; padding: 20px 20px;">
	<div class="row" style="padding:20px 20px; width:100%;">
    	...
    	<a class="addButton" href="AlumniCRUD?action=approveAlumni&userID=${userID}">Accept</a>
    	<a class="deleteButton" href="AlumniCRUD?action=rejectAlumni&userID=${userID}">Delete</a>
    </div>
<div class="theFooter">
	<h5>N. G.</h5>
	<h5>Alumni</h5>
